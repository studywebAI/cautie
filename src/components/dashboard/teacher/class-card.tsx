        ...
        <CardHeader>
          ...
          <div className="flex items-center text-sm text-muted-foreground pt-1 gap-4">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>{classInfo.assignmentsDue} Due Soon</span>
            </div>
          </div>
        </CardHeader>
        <CardContent className="flex-grow space-y-4">
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="text-sm font-bold text-primary">{classInfo.averageProgress}%</span>
            </div>
            <Progress value={classInfo.averageProgress} className="h-2" />
          </div>
          {classInfo.alerts.length > 0 && (
            <div>
              <Separator className="my-3" />
              <div className="space-y-2">
                {classInfo.alerts.map((alert, index) => (
