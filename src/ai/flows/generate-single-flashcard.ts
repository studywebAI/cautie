...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert in creating effective learning materials. Your task is to generate a single, unique flashcard based on the provided source text.
