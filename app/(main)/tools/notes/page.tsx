        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center mb-4">
            <div className="text-sm text-muted-foreground">
              Note Style: {mode.charAt(0).toUpperCase() + mode.slice(1).replace('-', ' ')}
            </div>
          </div>
          ...
          <div className="flex items-end gap-3">
            ...
            <div className="flex gap-2">
              <Button
                ...
                onClick={() => toast({ title: 'Import Previous Projects', description: 'This feature will be implemented soon.' })}
                disabled={isLoading || isProcessingFile}
              ...
              <Button
                ...
                size="icon"
                className="rounded-full h-12 w-12"
                onClick={() => toast({ title: 'Import from Other Apps', description: 'This feature will be implemented soon.' })}
                disabled={isLoading || isProcessingFile}
            ...
            {/* Hidden file input for bottom bar */}
            <Input
